...
export default function ContactBest() {
  return (
    <section
      id="contact"
      className="relative py-24 overflow-hidden bg-[#f8fafc]"
    >
      {/* --- Subtle Background Texture (Luxury touch) --- */}
      ...
      <div className="relative max-w-7xl mx-auto px-8">
        ...
        <div className="grid lg:grid-cols-5 gap-10">
          {/* LEFT: Contact Cards (Takes up 3/5 of the space) */}
          <div className="lg:col-span-3 space-y-6">
            {/* 1. Address */}
            <div className="group flex items-start gap-6 bg-white/80 backdrop-blur-sm border border-gray-200/80 p-7 rounded-3xl shadow-xl shadow-gray-200/50 hover:shadow-2xl hover:shadow-lime-200/30 transition-all duration-500 hover:-translate-y-1.5">
              <div className="w-14 h-14 bg-gradient-to-br from-lime-100 to-lime-200 rounded-2xl flex items-center justify-center text-lime-700 text-2xl shadow-inner shrink-0 group-hover:scale-105 transition-transform">
                <FaMapMarkerAlt />
              </div>
              <div className="flex-1">
                <div className="flex items-center justify-between">
                  <h3 className="font-bold text-xl text-gray-800">Address</h3>
                  <span className="text-xs font-medium text-lime-600 bg-lime-50 px-3 py-1 rounded-full border border-lime-200/50">
                    Visit us
                  </span>
                </div>
            ...
            <div className="group flex items-start gap-6 bg-white/80 backdrop-blur-sm border border-gray-200/80 p-7 rounded-3xl shadow-xl shadow-gray-200/50 hover:shadow-2xl hover:shadow-lime-200/30 transition-all duration-500 hover:-translate-y-1.5">
              ...
              <div className="flex-1">
                ...
                <a
                  href="tel:0813906634"
                  className="text-gray-600 text-lg hover:text-lime-700 transition-colors font-medium"
                >
                  081 390 6634
                </a>
            ...
            <div className="group flex items-start gap-6 bg-white/80 backdrop-blur-sm border border-gray-200/80 p-7 rounded-3xl shadow-xl shadow-gray-200/50 hover:shadow-2xl hover:shadow-lime-200/30 transition-all duration-500 hover:-translate-y-1.5">
              ...
              <div className="flex-1">
                ...
                <a
                  ...
                  className="text-gray-600 text-lg hover:text-lime-700 transition-colors"
                >
            ...
            {/* 4. Hours + Book Now CTA (Combined for impact) */}
            <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
              <div className="md:col-span-3 group flex items-start gap-6 bg-white/80 backdrop-blur-sm border border-gray-200/80 p-7 rounded-3xl shadow-xl shadow-gray-200/50 hover:shadow-2xl hover:shadow-lime-200/30 transition-all duration-500 hover:-translate-y-1.5">
                <div className="w-14 h-14 bg-gradient-to-br from-lime-100 to-lime-200 rounded-2xl flex items-center justify-center text-lime-700 text-2xl shadow-inner shrink-0 group-hover:scale-105 transition-transform">
                  <FaClock />
                </div>
                <div className="flex-1">
                  <div className="flex items-center gap-3">
                    <h3 className="font-bold text-xl text-gray-800">Hours</h3>
              ...
              {/* Quick Book Now Button inside the contact grid */}
              <div className="md:col-span-2 flex items-stretch">
               <a
  href="#booking"
  className="w-full flex items-center justify-center gap-3 bg-gradient-to-r from-lime-500 to-lime-600 hover:from-lime-600 hover:to-lime-700 text-white font-bold py-6 px-8 rounded-3xl shadow-lg shadow-lime-200/60 hover:shadow-xl hover:shadow-lime-300/70 transition-all duration-300 group text-lg"
>
  <span>Book Now</span>
  <FaArrowRight className="group-hover:translate-x-1.5 transition-transform" />
          ...
          {/* RIGHT: Map (Takes up 2/5 of the space) */}
          <div className="lg:col-span-2 flex flex-col">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl shadow-gray-300/50 border-2 border-white/50 bg-white p-1.5 transition-all duration-500 hover:shadow-2xl hover:shadow-lime-200/30 group/map">
              <div className="rounded-2xl overflow-hidden h-[500px] lg:h-[620px]">
                <iframe
              ...
              {/* A subtle glow overlay on the map container */}
            ...
            <a
              ...
              className="mt-6 flex items-center justify-center gap-3 bg-white border border-gray-200 hover:border-lime-400 text-gray-700 hover:text-lime-700 font-semibold py-4 px-8 rounded-2xl transition-all duration-300 shadow-md hover:shadow-lg hover:-translate-y-0.5 group"
            >
