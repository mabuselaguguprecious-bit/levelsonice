...
export default function About() {
  return (
    <section
      id="about"
      className="bg-slate-100 py-20 md:py-24 text-slate-900 overflow-x-hidden w-full"
    >
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-5 mt-10">
            <div className="bg-white rounded-2xl shadow-lg p-5 md:p-6 text-center">
              <h3 className="text-3xl md:text-4xl font-bold text-lime-500">7</h3>
              <p className="text-slate-600 mt-2 text-sm md:text-base">Days Open</p>
            </div>
            <div className="bg-white rounded-2xl shadow-lg p-5 md:p-6 text-center">
              <h3 className="text-3xl md:text-4xl font-bold text-lime-500">09:00</h3>
              <p className="text-slate-600 mt-2 text-sm md:text-base">Opens Weekdays</p>
            </div>
          </div>
        </div>
