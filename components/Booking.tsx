    ...
    >
      ...
      <div className="max-w-5xl mx-auto px-8">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-gray-600 text-lg leading-8 mt-8 max-w-3xl mx-auto">
        ...
        <form
          ...
          className="bg-white rounded-[36px] shadow-xl p-8 md:p-12"
        >
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <input
                ...
                className="w-full h-14 rounded-2xl border border-gray-300 px-5 text-gray-800 placeholder:text-gray-400 outline-none transition focus:border-lime-500 focus:ring-4 focus:ring-lime-100"
              />
            ...
            <div>
              ...
              <select
                ...
                className="w-full h-14 rounded-2xl border border-gray-300 px-5 text-gray-800 outline-none transition focus:border-lime-500 focus:ring-4 focus:ring-lime-100"
              >
          ...
          <div className="mt-8">
            ...
            <textarea
              ...
              className="w-full rounded-2xl border border-gray-300 p-5 text-gray-800 placeholder:text-gray-400 outline-none resize-none transition focus:border-lime-500 focus:ring-4 focus:ring-lime-100"
            />
          ...
          <div className="mt-8 rounded-3xl border border-lime-200 bg-lime-50 p-8">
            ...
            <p className="text-gray-600 mt-4 leading-8">
              Please read the following information before sending your
              booking request.
            </p>
            ...
            <ul className="mt-6 space-y-3 text-gray-700 leading-7">
              ...
              <li className="flex items-start gap-3">
                ...
                <span>
                  Your booking request will open in <strong>WhatsApp</strong>.
                </span>
              </li>
              ...
              <li className="flex items-start gap-3">
                <span className="text-lime-600 font-bold">✓</span>
                <span>
                  Your appointment is only confirmed once our team replies and confirms availability.
                </span>
              </li>
              ...
              <li className="flex items-start gap-3">
                <span className="text-lime-600 font-bold">✓</span>
                <span>
                  If you arrive more than <strong>5 minutes late</strong>,
                  a walk-in client may be attended to before you.
                </span>
              </li>
          ...
          <button
            type="submit"
            className="mt-10 w-full h-16 rounded-2xl bg-black text-white text-lg font-semibold flex items-center justify-center gap-3 transition-all duration-300 hover:bg-lime-500 hover:text-black hover:shadow-xl hover:shadow-lime-500/30"
          >
